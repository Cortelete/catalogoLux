...
export const remocaoLaser: Procedure = {
  id: 'remocao-laser',
  ...
  price: 'Agendar Avaliação',
  details: ['Remoção de Micropigmentação', 'Remoção de Tatuagens', 'Tecnologia segura', 'Valor baseado no tamanho e tipo de pigmentação'],
  images: [
